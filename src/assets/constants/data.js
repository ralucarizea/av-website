...
export const performanceCounterData = {
  ...
  1: { indicator: "ani de experiență", number: 12, color: "accents.lime" },
  2: { indicator: "ore de practică", number: 6000, color: "accents.red" },
...
export const resumeData = {
  0: {
    ...
    achievements: [
      ...
      "Participare la Conferința Națională APAR - ediția XVIII, pe tema `TULBURĂRI NEUROCOGNITIVE`, conferință avizată de Colegiul Psihologilor din România cu 32 credite profesionale la care am participat fizic în perioada 20-23 aprilie 2023",
      "Participare la Conferința Națională de Psihiatrie și Psihologie medico-legală, unde am participat fizic în perioada 23-25 noiembrie 2023, Sibiu.",
    ],
    years: ["2023 - prezent"],
    bgColor: "rgb(255, 220, 214)",
    color: "rgb(38, 126, 93)",
    icon: "",
  },
  1: {
    ...
    achievements: [
      ...
      "Curs specializare 12 luni intensiv `Psihosexologie - Evaluare și intervenție terapeutică` - Curs organizat de Institutul SPER - Societate de Psihoterapie Experențială Română din București (debutul în februarie)",
    ],
    years: ["2022 - 2023"],
    bgColor: "rgb(243, 240, 255)",
    color: "rgb(80, 47, 111)",
    icon: "",
  },
  2: {
  ...
  3: {
    ...
    years: ["2020 - 2021"],
    bgColor: "rgb(208, 83, 64)",
    color: "rgb(251, 238, 224)",
    icon: "",
  },
  4: {
    // title: "Workshop-uri",
